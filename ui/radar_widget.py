# -*- coding: utf-8 -*-
"""
Falcon-Eye GCI — Tactical radar by Riesu (contact@falcon-charts.com) — GPL v3
Nouveautés v5:
...
<div id="hud">
  ...
  <div style="color:#1a5a2a;font-size:7px;margin-top:3px">Falcon-Eye</div>
</div>
...
<div id="radio-panel" class="hidden">
  <div id="radio-drag-bar">
    <div class="radio-title"><div class="radio-dot"></div>RADIO FALCON-EYE</div>
  ...
  <div class="opt-body">
    ...
    <div style="padding:10px 12px;border-top:1px solid rgba(0,180,80,.15);text-align:center">
      <div style="padding:16px;border-top:1px solid rgba(0,180,80,.2);text-align:center">
          ...
          <div style="font-size:16px;font-weight:bold;color:#00e5ff;letter-spacing:2px;margin-bottom:6px">FALCON-EYE GCI</div>
